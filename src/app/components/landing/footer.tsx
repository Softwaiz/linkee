...
export function Footer() {
    return (
        <footer className="border-t border-border px-6 py-10">
            <div className="mx-auto max-w-[1080px] flex flex-col gap-8">
                {/* Top: logo + use-case column */}
                <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                    ...
                    {/* Use cases nav */}
                    <nav aria-label="Use cases navigation" className="flex flex-col gap-2">
                        <p className="text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-1">Use cases</p>
